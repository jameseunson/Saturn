...
struct KeychainItem {
    ...
    func readItem(account: String) throws -> String {
        /*
    ...
    func saveItem(account: String, _ password: String) throws {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.example.apple-samplecode.juice").readItem(account: "userIdentifier")
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.example.apple-samplecode.juice").deleteItem(account: "userIdentifier")
        } catch {
